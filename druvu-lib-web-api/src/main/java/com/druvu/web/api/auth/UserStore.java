 ...
 *
 * <p>Implementations provide permission data for authenticated users. The API module includes {@link InMemoryUserStore}
 * for simple use cases. For production, implement this interface to integrate with your user store (database, LDAP,
 * etc.).
 *
 * @author Deniss Larka
 */
