 ...
 *
 * <p>Implementations are discovered via ServiceLoader using druvu-lib-loader. Each plugin registers its servlet(s)
 * during context initialisation.
 *
 * <p>Expected to be registered in module-info.java:
 *
 * <pre>
...
public interface TemplateEnginePlugin {
     ...
     *
     * <p>The handler parameter is an {@code org.eclipse.jetty.ee10.servlet.ServletContextHandler} passed as Object to
     * avoid tight coupling with Jetty in the API module. Implementations should cast it appropriately.
     *
