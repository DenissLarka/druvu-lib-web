 ...
 *
 * <p>Currently supports: - String literals: 'text', "text" - String concatenation: expr . expr - Function calls:
 * name(), name('arg'), name('a', 'b') - Escape sequences: \', \", \\, \n, \r, \t
 */
public class PhpExpressionParser {
    ...
    /** Parses concatenation expressions (the lowest precedence). Example: 'Hello' . ' ' . 'World' */
    ...
    /**
     * Parses an identifier. If followed by '(', treats it as a function call. Otherwise, throws (variables are not yet
     * supported).
     */
    ...
    /** Parses a string literal with the given quote character. Handles escape sequences like \', \", \\, \n, \r, \t */
